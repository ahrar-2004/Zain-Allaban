    ...
    <div className="bg-white">
      ...
      <section className="py-16 bg-[#FDF5AA]">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold text-[#113F67] mb-4">
            Our <span className="text-[#34699A]">Ice Cream Services</span>
          </h1>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#113F67] mb-4">What We Offer</h2>
              ...
              <div
                ...
                className={`relative p-8 rounded-xl border ${
                  service.popular
                    ...
                    : 'border-gray-200 bg-white hover:border-[#34699A]'
                } transition-colors`}
              >
                {service.popular && (
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                    <span className="bg-[#34699A] text-white px-3 py-1 rounded-full text-xs font-medium">
                      Most Popular
                    </span>
                  </div>
                )}
                <div className="text-[#34699A] mb-6">{service.icon}</div>
                <h3 className="text-xl font-semibold text-[#113F67] mb-3">{service.title}</h3>
                <p className="text-gray-600 mb-6">{service.description}</p>
                <ul className="space-y-3">
                  {service.features.map((feature, idx) => (
                    <li key={idx} className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-[#58A0C8] mt-0.5 mr-3 flex-shrink-0" />
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#113F67] mb-4">Extra Sweet Services</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {additionalServices.map((service, index) => (
              <div
                key={index}
                className="p-6 rounded-lg bg-white border border-gray-200 hover:border-[#34699A] transition-colors"
              >
                <div className="text-[#34699A] mb-4">{service.icon}</div>
                <h3 className="text-lg font-medium text-[#113F67] mb-2">{service.title}</h3>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-[#113F67] mb-6">Craving Something Sweet?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/contact"
              className="bg-[#34699A] hover:bg-[#113F67] text-white px-8 py-3 rounded-full inline-flex items-center justify-center font-medium"
            >
