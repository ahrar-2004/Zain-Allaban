        ...
        <section className="space-y-6">
          ...
          {[
            ...
            },
            {
              ...
              title: 'Email',
              content: (
                <a href="mailto:zainallabanicecream@gmail.com" className="text-[#3c859e] hover:underline">
                  zainallabanicecream@gmail.com
                </a>
              )
            },
            {
              ...
              content: (
                <p className="text-[#4a4a4a] text-sm leading-relaxed">
                  Al Barsha, Near Mall of the Emirates,<br />
                  Dubai, UAE
                </p>
              )
            }
          ...
          <div className="p-4 bg-[#deeaef] rounded-md border border-[#cbdde3]">
            ...
            <p className="text-[#4a4a4a] text-sm">Open daily from 10:00 AM to 12:00 AM</p>
          </div>
        </section>
